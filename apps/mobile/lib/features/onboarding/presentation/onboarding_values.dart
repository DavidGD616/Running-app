...
abstract final class OnboardingValues {
  ...
  static const sleepLessThan5h = 'sleep_less_than_5h';
  static const sleep5to6h = 'sleep_5_to_6h';
  static const sleep6to7h = 'sleep_6_to_7h';
  static const sleep7to8h = 'sleep_7_to_8h';
  static const sleep8plusH = 'sleep_8_plus_h';

  static const workMostlyDesk = 'work_mostly_desk';
  static const workMixed = 'work_mixed';
  static const workPhysical = 'work_physical';

  static const stressLow = 'stress_low';
  static const stressModerate = 'stress_moderate';
  static const stressHigh = 'stress_high';

  static const feelingFresh = 'feeling_fresh';
  static const feelingSometimesTired = 'feeling_sometimes_tired';
  static const feelingOftenTired = 'feeling_often_tired';
  static const feelingAlwaysTired = 'feeling_always_tired';

  static const motivationPersonalChallenge = 'motivation_personal_challenge';
  static const motivationHealth = 'motivation_health';
  static const motivationWeightLoss = 'motivation_weight_loss';
  static const motivationImprovePerformance = 'motivation_improve_performance';
  static const motivationRaceFriends = 'motivation_race_friends';
  static const motivationDiscipline = 'motivation_discipline';
  static const motivationOther = 'motivation_other';

  static const barrierTime = 'barrier_time';
  static const barrierMotivation = 'barrier_motivation';
  static const barrierFatigue = 'barrier_fatigue';
  static const barrierStress = 'barrier_stress';
  static const barrierPain = 'barrier_pain';
  static const barrierBoredom = 'barrier_boredom';
  static const barrierDontKnowHow = 'barrier_dont_know_how';
  static const barrierOther = 'barrier_other';

  static const toneSimple = 'tone_simple';
  static const toneEncouraging = 'tone_encouraging';
  static const toneDetailed = 'tone_detailed';
  static const toneStrict = 'tone_strict';
  ...
  static String localizeSleep(String key, AppLocalizations l10n) {
    switch (key) {
      case sleepLessThan5h:
        return l10n.sleepLessThan5h;
      case sleep5to6h:
        return l10n.sleep5to6h;
      case sleep6to7h:
        return l10n.sleep6to7h;
      case sleep7to8h:
        return l10n.sleep7to8h;
      case sleep8plusH:
        return l10n.sleep8plusH;
      default:
        return key;
    }
  }

  static String localizeWorkLevel(String key, AppLocalizations l10n) {
    switch (key) {
      case workMostlyDesk:
        return l10n.workMostlyDesk;
      case workMixed:
        return l10n.workMixed;
      case workPhysical:
        return l10n.workPhysical;
      default:
        return key;
    }
  }

  static String localizeStress(String key, AppLocalizations l10n) {
    switch (key) {
      case stressLow:
        return l10n.stressLow;
      case stressModerate:
        return l10n.stressModerate;
      case stressHigh:
  ...
  static String localizeDayFeeling(String key, AppLocalizations l10n) {
    switch (key) {
      case feelingFresh:
        return l10n.feelingFresh;
      case feelingSometimesTired:
        return l10n.feelingSometimesTired;
      case feelingOftenTired:
        return l10n.feelingOftenTired;
      case feelingAlwaysTired:
        return l10n.feelingAlwaysTired;
      default:
        return key;
    }
  }

  static String localizeMotivation(String key, AppLocalizations l10n) {
    switch (key) {
      case motivationPersonalChallenge:
        return l10n.motivationPersonalChallenge;
      case motivationHealth:
        return l10n.motivationHealth;
      case motivationWeightLoss:
        return l10n.motivationWeightLoss;
      case motivationImprovePerformance:
        return l10n.motivationImprovePerformance;
      case motivationRaceFriends:
        return l10n.motivationRaceFriends;
      case motivationDiscipline:
        return l10n.motivationDiscipline;
      case motivationOther:
        return l10n.motivationOther;
      default:
        return key;
    }
  }

  static String localizeBarrier(String key, AppLocalizations l10n) {
    switch (key) {
      case barrierTime:
        return l10n.barrierTime;
      case barrierMotivation:
        return l10n.barrierMotivation;
      case barrierFatigue:
        return l10n.barrierFatigue;
      case barrierStress:
        return l10n.barrierStress;
      case barrierPain:
        return l10n.barrierPain;
      case barrierBoredom:
        return l10n.barrierBoredom;
      case barrierDontKnowHow:
        return l10n.barrierDontKnowHow;
      case barrierOther:
        return l10n.barrierOther;
      default:
        return key;
    }
  }

  static String localizeCoachingTone(String key, AppLocalizations l10n) {
    switch (key) {
      case toneSimple:
        return l10n.toneSimple;
      case toneEncouraging:
        return l10n.toneEncouraging;
      case toneDetailed:
        return l10n.toneDetailed;
      case toneStrict:
        return l10n.toneStrict;
      default:
        return key;
    }
  }
