...
void main() {
  ...
  Widget wrap(
    ...
    final router = GoRouter(
      ...
      routes: [
        ...
        GoRoute(
          path: '/active-run',
          builder: (context, state) => const Scaffold(body: Text('active-run')),
        ),
      ],
    );
  ...
  testWidgets('starts GPS run when distance workout has always permission', (
    ...
    await tester.pumpWidget(wrap(args, locationPermissionService: service));
    await tester.pumpAndSettle();
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      final args = PreRunArgs.fromSession(session);
      final service = _MockLocationPermissionService(serviceEnabled: false);
